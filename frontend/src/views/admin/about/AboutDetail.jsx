...
export default function AboutDetail() {
  ...
  const fetchData = async ()=>{
   const res = await  axiosClient.get('aboutdetails/index');
  ...
  const handleOnSubmit = (event)=>{
    ...
    axiosClient.post(`aboutdetails/store/${params.id}`,aboutus).then((response)=>{
  ...
  const handleedit = (id)=>{
      axiosClient.get(`aboutdetails/edit/${id}`).then((response)=>{
  ...
  const handleupdate = (event)=>{
     event.preventDefault();
     axiosClient.post(`aboutdetails/update/${aboutus.id}`,aboutus);


  }

  const handledelete = (id)=>{
      axiosClient.get(`aboutdetails/delete/${id}`);
